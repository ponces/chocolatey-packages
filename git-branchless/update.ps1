...
function global:au_GetLatest {
  $LatestRelease = Get-GitHubRelease arxanas git-branchless

  return @{
    Version     = $LatestRelease.tag_name.TrimStart("v")
    URL64       = $LatestRelease.assets | Where-Object {$_.name.EndsWith("-windows-msvc.zip")} | Select-Object -ExpandProperty browser_download_url
